c# 🚀 Konex - Deployment Checklist & Pending Features
...
8. `supabase/commission-system.sql` - Commissions, payouts, subscription tiers
...
- ✅ Commission database schema (`commissions`, `commission_payouts` tables)
- ✅ Subscription tiers (Starter/Growth/Scale) with different fee rates
- ✅ Commission calculation functions in database
- ✅ Creator earnings display on dashboard
- ✅ SaaS commission due display on dashboard
- ✅ Payout API endpoint (`/api/payouts/request`)
- ✅ Stripe Connect transfer integration

**Subscription Tiers:**
| Plan | Price | Max Creators | SaaS Fee | Total Konex Cut |
|------|-------|--------------|----------|-----------------|
| Starter | FREE | 3 | 5% | 7.25% |
| Growth | €59/mo | 10 | 3% | 5.25% |
| Scale | €89/mo | Unlimited | 1% | 3.25% |

**Commission Flow:**

1. Revenue tracked via `/c/[hash]` links
2. Monthly commission calculation (15% to creator)
3. Konex takes 15% of creator earnings
4. Creator requests payout when ≥€50 pending
5. Stripe Connect transfer to creator's account
...
_This document should be updated as features are completed or requirements change._
